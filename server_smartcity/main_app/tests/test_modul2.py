...
class PrivacyAndDataHidingTests(APITestCase):
    ...
    def test_PRIV_03_tidak_bisa_baca_draf_orang_lain(self):
        ...
        url = reverse('report-detail', args=[self.draft_milik_b.pk])
    ...
    def test_PRIV_04_tidak_bisa_modifikasi_draf_orang_lain(self):
        ...
        self.assertEqual(
            response.status_code,
            status.HTTP_404_NOT_FOUND,
            "Draf milik warga lain tidak boleh ditemukan untuk operasi PUT"
        )
        ...
        self.assertEqual(
            ...
            "Data draf milik warga lain tidak boleh berubah"
        )
