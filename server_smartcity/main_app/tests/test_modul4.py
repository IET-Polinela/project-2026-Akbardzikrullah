...
class CRUDAndValidationTests(APITestCase):
    ...
    def test_FT_01_buat_laporan_dengan_data_lengkap(self):
        ...
        payload = {
            'title': 'Jalan Licin Setelah Hujan',
            'category': 'Infrastruktur',
            'description': 'Permukaan jalan menjadi sangat licin setelah hujan.',
        ...
        self.assertEqual(
            ...
            "Pembuatan laporan dengan data lengkap harus berhasil"
        )
        ...
        self.assertEqual(laporan.title, payload['title'])
    ...
    def test_FT_03_ditolak_jika_deskripsi_kosong(self):
        ...
        payload = {
            ...
            'description': '',
            'location': 'Jalan Depan Perpustakaan',
        }
